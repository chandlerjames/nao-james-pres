...
Gelman and King (1993) contend that pre-presidential election opinion poll responses are amiss because voters are generally uninformed until near or at election day. Prior to the election, voters are generally uninformed and respond likewise. They propose that voters are educated by presidential campaigns and ultimately decide their vote based on their enlightened preferences that they identify over the course of the campaign. These enlightened preferences are more in accord with economic and political conditions. 

This paper assesses the determinants of vote choice by simulating the conditions of campaign election through the use of information provided in frames of economic, policy, and personality issues likely to arise in the 2024 campaign. 

Research Questions:

* Why do incumbent job approval ratings in the months leading up to election underestimate incumbent vote share in the general election? 
* More broadly, why are presidential polls variable?
* Do campaigns inform voters? 
* What issues drive vote choice? 
...
* H1: Respondents assigned to the ECONOMIC treatment condition will express relatively greater preference to Biden than those assigned to the control group as measured by feeling thermometers and vote choice. We expect this effect is strongest among Biden 2020 voters and Democrats.
...
* H1c: Liberals assigned to the ECONOMIC treatments will favor Joe Biden more than that conservatives assigned to the CONTROL condition.
...
* H2c: Liberals assigned to the POLICY treatments will favor Joe Biden more than that conservatives assigned to the CONTROL condition.
* H2d: Younger voters assigned to the POLICY treatments will favor Democrats more than younger voters assigned to the CONTROL condition.

#### Character Treatment 

* H3: Respondents assigned to the CHARACTER treatment condition will express greater preference for Biden compared to the control as measured by vote choice and feeling thermometers. We expect this effect is strongest among Biden 2020 voters and Democrats.
...
3. Respondents will be randomly assigned to one of 6 treatment conditions.

* Economic treatment (question + answer)
* Economic control (question)
* Policy treatment (policy divergence)
* Policy control
* Character treatment (Trump unpresidential actions)
* Character control (Trump and Biden presidential actions)
...
Next, all respondents are asked pre-treatment economic, policy, and political questions. Respondents are then randomly assigned to one of six treatment conditions. 
...
Randomization is essential for this study. Respondents will assigned by simple randomization to one of the six treatment conditions. Each treatment condition will be assigned roughly the same number of respondents. 
...
* Economic treatment (question + answer)
1. Growth - Surprise (y/n)
2. Jobs and Unemployment - Surprise (y/n)
3. Inflation - Surprise (y/n)

* Policy treatment (policy divergence)
1. Abortion - Surprise (y/n)
2. Environmental - Surprise (y/n)
3. Gaza - Surprise (y/n)

* Character treatment (Trump unpresidential actions)
1. January 6 - How presidential? (-50-50)
2. Terminate Constitution - How presidential? (-50-50)
3. Bible- How presidential? (-50-50)


* Character Control (Trump presidential actions)
1. State of the Union - How presidential? (-50-50)
2. Trump Disaster - How presidential? (-50-50)
3. Trump Thanksgiving - How presidential? (-50-50)
...
* Political knowledge
- Is Chuck Schumer a Republican or Democrat?
...
- Do you happen to know what job or political office is now held by John G. Roberts?
...
We expect heterogeneous treatment effects for member of different demographics. Therefore we will look for heterogeneous treatment effects among different demographic variables (age, gender, income, race, and education)
